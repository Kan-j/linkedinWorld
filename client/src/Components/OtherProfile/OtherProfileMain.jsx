...
import { BsPerson, BsPersonAdd, BsPersonFill, BsPlug, BsPlugFill, BsTelegram } from 'react-icons/bs'

export default function OtherProfileMain() {
  return (
    <>
        <div className='basis-8/12 flex flex-col gap-3 mr-5 h-fit'>
            ...
            <section className='bg-white px-10 py-5 rounded-lg mb-3'>
                <p className='font-semibold text-gray-700 text-xl mb-2'>About</p>
